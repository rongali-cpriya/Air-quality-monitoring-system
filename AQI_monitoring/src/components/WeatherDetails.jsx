              ...
              <div className="air-quality-section">
                ...
                <div className="pollutants-grid">
                  <div className="pollutant-card">
                    <h3>PM2.5</h3>
                    <p>{nearestStation?.pm25 || "N/A"} μg/m³</p>
                  </div>
                  <div className="pollutant-card">
                    <h3>PM10</h3>
                    <p>{nearestStation?.pm10 || "N/A"} μg/m³</p>
                  </div>
                  <div className="pollutant-card">
                    <h3>O₃</h3>
                    <p>{nearestStation?.o3 || "N/A"} μg/m³</p>
                  </div>
                  <div className="pollutant-card">
                    <h3>NO₂</h3>
                    <p>{nearestStation?.no2 || "N/A"} μg/m³</p>
                  </div>
                  <div className="pollutant-card">
                    <h3>SO₂</h3>
                    <p>{nearestStation?.so2 || "N/A"} μg/m³</p>
                  </div>
                  <div className="pollutant-card">
                    <h3>CO</h3>
                    <p>{nearestStation?.co || "N/A"} μg/m³</p>
                  </div>
                </div>
              </div>
